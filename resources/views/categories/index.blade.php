                                ...
                                <tbody>
                                    @foreach ($categories as $key => $category)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>
                                                {{ $category->name_ar?? 'لا يوجد' }}
                                            </td>
                                            <td>
                                                {{ $category->name_en?? 'لا يوجد' }}
                                            </td>
                                            <td>
                                            ...
                                            event.preventDefault();}"><i
                                                ...
                                                <form id="delete-users_{{ $category->id }}"
                                                    action="/panel-admin/categories/{{ $category->id }}" method="POST"
                                                    class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form form-vertical" action="/panel-admin/categories" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="email-id-vertical">الاسم بالعربي</label>
                                        <input type="text"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="email-id-vertical">الاسم بالانجليزي</label>
                                        <input type="text"
